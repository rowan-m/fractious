...
const interactionManager = new InteractionManager(elements, config, state, interactionCallbacks);
...
export { Fractious, Renderer, WorkerManager, InteractionManager, createDefaultConfig, createDefaultState };